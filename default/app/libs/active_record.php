...
class ActiveRecord extends KumbiaActiveRecord  {
    ...
    public function paginated() {
        ...
        require_once APP_PATH . 'libs/mkc_paginate.php';
        return call_user_func_array(array('MkcPaginate' , 'paginate'), $args);
    }       
    ...
    public function paginated_by_sql($sql) {
        ...
        array_unshift($args, $this);
        require_once APP_PATH . 'libs/mkc_paginate.php';
        return call_user_func_array(array('MkcPaginate' , 'paginate_by_sql'), $args);
    }
