...
class View extends KumbiaView {
    ...
    public static function notify($unique=true) {
        if($unique) {
            return self::partial('mkc_message');
        } else {
            return self::partial('mkc_message', false, array('id'=>rand(1,5000)));
        }
    }
    ...
    public static function process($modulo, $proceso=null, $title=true) {
        return self::partial('mkc_process', false, array('modulo'=>$modulo, 'proceso'=>$proceso, 'titulo'=>$title));
    }
    ...
    public static function redirect($url) {
        ...
        return self::partial('mkc_redirect', false, array('url'=>$url));
    }
