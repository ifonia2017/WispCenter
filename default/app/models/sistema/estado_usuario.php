...
class EstadoUsuario extends ActiveRecord {
    ...
    public function after_create() {
        ...
        if($this->estado_usuario == self::COD_ACTIVO) {
            MkcAudit::debug("Se activa el acceso al usuario $usuario->login. Motivo: $this->descripcion");
        } else if($this->estado_usuario == self::COD_BLOQUEADO) {
            MkcAudit::debug("Se bloquea el acceso al sistema al usuario $usuario->login. Motivo: $this->descripcion");
        }
