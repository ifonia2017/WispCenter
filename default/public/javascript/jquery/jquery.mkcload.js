...
(function($) {
    ...
    var defaults = {
        ...
        capa            : 'mkc-shell-content', //Capa a actualizar
    ...
    $.mkcload = function(options) {
        ...
        $.ajax({
            ...
            error: function (xhr, text, err) {
                ...
                if(opt.msg==true) {
                    try {
                        $('#mkc-error-ajax').html(response);
                        if($('#mkc-info-error-ajax').size() > 0) {
                             $('#mkc-info-error-ajax').html(xhr.responseText);
                        }
                        errorAjax();
                    } catch(e) {
