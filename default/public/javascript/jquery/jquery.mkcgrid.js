(function($){
    ...
    var methods = {
        ...
        init : function( options ) {
                    ...
                    var opt = {
                        ...
                        form_attr       : 'class="mkc-form js-remote form-search"',
                        order_attr      : 'class="mkc-ajax data-order mkc-spinner"',
                        col_collapse    : 'col-collapse',
                        order_action    : '',
                        contenedor      : 'mkc-shell-content',
                    ...
                    return this.each(function(k) {
                        ...
                        if(table.parent().hasClass('mkc-overflow')) {
                        ...
                        (table.parent().hasClass('mkc-overflow')) ? table.parent().before(container) : table.before(container);
                        ...
                        if(opt.form_search) {
                            container.find('.btn-actions').prepend('<button class="btn btn-info mkc-text-bold btn-form-search"><i class="btn-icon-only icon-search"></i> <span class="hidden-phone">BUSCAR</span></button>');
    ...
    $.fn.mkcGrid = function(method){
        ...
        if ( methods[method] ) {
            ...
            $.error( 'Este método ' +  method + ' no existe en jQuery.mkcGrid' );
            return false;
        }
    };
