...
(function($) {
    ...
    $.KumbiaPHP = {
        ...
        cConfirm: function(event) {
            ...
            if(este.hasClass('mkc-ajax')) {
                footer.append('<a class="btn btn-success mkc-ajax mkc-spinner" href="'+este.attr("href")+'">Aceptar</a>');
            } else {
        ...
        cFRemote: function(event){
            ...
            if(este.hasClass('mkc-validate')) { //Para validar el formulario antes de enviarlo
                confirmation = este.hasClass('mkc-confirm') ? true : false;
        ...
        cReport: function(event) {
            ...
            $('.btn-success', reporte).on('click',function(){
                ...
                (checked=='ticket') ? MkcPopupTicket(popup_url) : MkcPopupReport(popup_url);
            });
            reporte.modal();
        },
